...
//         className="border border-gray-300 p-2 rounded-md w-full md:w-1/2 focus:outline-none focus:ring-2 focus:ring-blue-400"
//       />
//       <select
//         value={cityFilter}
//         onChange={(e) => dispatch(setCityFilter(e.target.value))}
//         className="border border-gray-300 p-2 rounded-md w-full md:w-1/4 focus:outline-none focus:ring-2 focus:ring-blue-400"
//       >
